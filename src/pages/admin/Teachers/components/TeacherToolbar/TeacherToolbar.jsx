...
import { Search, RotateCcw, Filter, ArrowUpDown, RefreshCw, Download, X, Building2, UserCheck, CheckSquare } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3.5 flex-1 flex-wrap">
        ...
        <div className="relative min-w-[170px] flex-1 sm:flex-initial">
          ...
          >
            ...
            <option value="id-asc">Sort: Teacher ID (Low-High)</option>
            <option value="experience-desc">Sort: Experience (High-Low)</option>
            <option value="joining-desc">Sort: Joining Date (New-Old)</option>
          </select>
          <span className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-slate-400">
