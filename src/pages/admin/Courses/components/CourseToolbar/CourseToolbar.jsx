...
import { Search, RotateCcw, Filter, ArrowUpDown, RefreshCw, Download, X, Building2 } from 'lucide-react';
import './CourseToolbar.css';

/**
 * CourseToolbar Component
 * Renders the search input, department selector, status dropdown, sort select, and action triggers.
 */
export default function CourseToolbar({
  ...
  return (
    <div className="bg-white p-4.5 rounded-2xl border border-slate-200/80 shadow-ambient inner-highlight flex flex-col xl:flex-row xl:items-center justify-between gap-4 select-none">
      ...
      {/* Left Area: Search, Department, Status, and Sort selectors */}
      ...
      {/* Right Area: Actions (Refresh, Export, Reset) */}
