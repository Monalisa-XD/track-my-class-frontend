...
import { Search, RotateCcw, Filter, ArrowUpDown, RefreshCw, Download, X, Building2, GraduationCap, Calendar } from 'lucide-react';
import { DEPARTMENTS, COURSES, SEMESTERS } from '../../data/subjectsData';
import './SubjectToolbar.css';
...
export default function SubjectToolbar({
  ...
  return (
    <div className="bg-white p-4.5 rounded-2xl border border-slate-200/80 shadow-ambient inner-highlight flex flex-col xl:flex-row xl:items-center justify-between gap-4 select-none">
      ...
      {/* Left Area: Search, Department, Course, Semester, and Sort selectors */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3.5 flex-1 flex-wrap">
        ...
        <div className="relative min-w-[160px] flex-1 sm:flex-initial">
          ...
          >
            ...
            <option value="semester-asc">Sort: Semester (1-8)</option>
