...
import { Search, RotateCcw, Filter, ArrowUpDown, RefreshCw, Download, X, Building2, GraduationCap, Calendar, CheckSquare } from 'lucide-react';
import { DEPARTMENTS, COURSES, SEMESTERS } from '../../data/studentsData';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3.5 flex-1 flex-wrap">
        ...
        <div className="relative flex-1 min-w-[240px] max-w-xs">
          ...
          <input
            ...
            placeholder="Search students by Reg No or name..."
        ...
        <div className="relative min-w-[170px] flex-1 sm:flex-initial">
          ...
          >
            ...
            <option value="regNo-asc">Sort: Reg No (Low-High)</option>
            <option value="admissionDate-desc">Sort: Admission (New-Old)</option>
          </select>
          <span className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-slate-400">
