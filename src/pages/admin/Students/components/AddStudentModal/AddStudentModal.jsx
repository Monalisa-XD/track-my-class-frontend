            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full px-3.5 py-2 text-sm bg-slate-50 border rounded-xl outline-none focus:bg-white focus:ring-4 transition-all duration-200 font-semibold ${
                  errors.regNo ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'
                } text-slate-800 font-mono`}
              />
              {errors.regNo && (
                <p className="text-xs font-bold text-red-500">{errors.regNo}</p>
              )}
            </div>
