      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-2xl overflow-hidden transform transition-all duration-300 ease-out flex flex-col">
        ...
        <div className="p-6 space-y-3">
          <p className="text-sm font-semibold text-slate-600 leading-relaxed">
            Are you sure you want to delete the class roster <span className="font-bold text-slate-800">{selectedClass.name}</span> (<strong className="font-mono text-slate-900">{selectedClass.code}</strong>)?
          </p>
          <div className="p-3.5 rounded-xl bg-red-50/50 border border-red-100 text-xs font-medium text-red-700 leading-relaxed">
            <strong>Warning:</strong> Deleting this class config will clear class assignments, active timetable scheduling maps, and automatic attendance trackers linked with this class division.
          </div>
        </div>
