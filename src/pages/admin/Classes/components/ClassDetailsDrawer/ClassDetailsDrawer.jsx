...
import { X, Calendar, MapPin, Users, BookOpen, GraduationCap, Building2, User } from 'lucide-react';
        ...
        <div className="w-screen max-w-md bg-white border-l border-slate-200/80 shadow-2xl flex flex-col transform transition-transform duration-300 ease-out animate-slide-in-right">
          ...
          <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/50">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-800 tracking-tight">Class Details</h3>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="flex flex-col items-center text-center p-5 rounded-2xl bg-gradient-to-b from-blue-50/50 via-white to-white border border-blue-100/40 shadow-2xs relative">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-500 to-indigo-600 text-white flex items-center justify-center font-black text-xl shadow-md border border-blue-200/20 shrink-0">
                {cls.code.replace('CL-', '').substring(0, 3)}
              </div>
              ...
              <p className="text-xs font-semibold text-slate-500 mt-0.5">
                {cls.course} Program ({cls.semester})
              </p>
              ...
              <div className="flex items-center gap-1.5 mt-3">
                ...
                <span className="inline-flex items-center gap-1 px-2.5 py-1 text-xs rounded-lg bg-slate-50 text-slate-600 border border-slate-200/60 font-bold leading-none">
                  ...
                  <span>{cls.department} Branch</span>
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-slate-50/50 border border-slate-100 rounded-xl flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="text-[9px] text-slate-400 font-bold block uppercase leading-none">Enrolled Students</span>
                    <strong className="text-xs text-slate-700 font-bold mt-0.5 block">{cls.studentCount} Students</strong>
                  </div>
                </div>
                ...
                <div className="p-3 bg-slate-50/50 border border-slate-100 rounded-xl flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="text-[9px] text-slate-400 font-bold block uppercase leading-none">Academic Year</span>
                    <strong className="text-xs text-slate-700 font-bold mt-0.5 block font-mono">{cls.academicYear}</strong>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2.5">
                <div className="flex items-center gap-3 p-3 bg-slate-50/30 border border-slate-100 rounded-xl">
                  ...
                  <div>
                    ...
                    <strong className="text-xs text-slate-750 font-bold mt-0.5 block">{cls.classroom}</strong>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-slate-50/30 border border-slate-100 rounded-xl">
                  ...
                  <div>
                    <span className="text-[9px] text-slate-400 font-bold block uppercase leading-none">Class Teacher</span>
                    <strong className="text-xs text-slate-750 font-bold mt-0.5 block">{cls.classTeacher}</strong>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50/30 border border-slate-100 rounded-xl">
                ...
                <div>
                  <span className="text-[9px] text-slate-400 font-bold block uppercase leading-none">Created Date</span>
                  <strong className="text-xs text-slate-700 font-bold mt-0.5 block font-mono">{cls.createdDate}</strong>
                </div>
              </div>
            </div>
